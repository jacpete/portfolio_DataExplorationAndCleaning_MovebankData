...
subtitle: ''
summary: 'An entry into my data science portfolio that showcases exploratory analysis, data cleaning procedures including error checking, and some simple statistical analyses.'
authors: []
...
```{r Plot-Spatial-Map, warning=FALSE, message=FALSE, fig.align='center', fig.cap="Distribution of movement data across all study regions"}
...
#Save for project featuredFile on website
distMapWebsite <- distMap + tm_layout(main.title = "")
tmap_save(distMapWebsite, filename = "featured.png")
