...
#Should the Appenix be outputted?
...
First,  I identified the distribution of individuals across the study regions (This is a \hyperlink{Plot-Individuals-Per-Study-Region}{{\color{blue}{\underline{`r figNum("Plot-Individuals-Per-Study-Region", display = "cite")`}}}}).
